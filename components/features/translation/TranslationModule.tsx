  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">AI Translation</h1>
      ...
      <div className="glass-card p-4 flex items-center justify-center gap-4">
        ...
        <button
          ...
          className="group relative p-2.5 rounded-xl bg-slate-800/60 border border-slate-700/50 hover:border-sky-500/40 hover:bg-sky-500/10 transition-all duration-300"
        ...
        <div className="space-y-3">
          ...
          <div className="glass-card p-1">
            <textarea
              ...
              rows={6}
              className="w-full bg-transparent text-white placeholder-slate-600 p-4 resize-none focus:outline-none text-base leading-relaxed"
            />
          </div>
          ...
          <button
            ...
            className="w-full btn-primary flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:transform-none"
          >
            {isLoading ? (
              <>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            {result?.translatedText && (
              <button
                onClick={handleCopy}
                className="flex items-center gap-1.5 text-xs font-medium text-slate-400 hover:text-white transition-colors px-2 py-1 rounded-md hover:bg-white/5"
              >
                {copied ? (
                  <>
