  ...
  if (isValid) {
    return (
      <div className="glass-card p-6 border-emerald-500/30 bg-emerald-500/5 flex items-center gap-4">
        ...
        <div>
          <h3 className="text-lg font-bold text-white">Ausgezeichnet!</h3>
          <p className="text-slate-400">Your text has no grammatical or spelling errors.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-bold text-white">{errors.length} Fehler gefunden</h3>
      </div>

      {errors.map((error, idx) => (
        <div key={idx} className="glass-panel p-5 rounded-xl border border-slate-700/50">
          ...
          <div className="flex items-center gap-4 mb-4 font-mono text-lg bg-slate-900/50 p-3 rounded-lg">
